...
def stop():
    cmd_vel_pub = rospy.Publisher("cmd_akm4", Twist, queue_size=10)
    twist = Twist()
    twist.linear.x = 0.0
    twist.angular.z = 0.0
    for i in range(20):
...
if __name__ == '__main__':
    # time.sleep(0.2)
    rospy.init_node("follower3")
    rospy.Subscriber("/deepracer4/camera/zed_left/image_rect_color_left", Image, image_callback)
    rospy.spin()
    pass
